...
class Card:
    ...
    def __eq__(self, other):
        if isinstance(other, Card):
            return self.name == other.name and self.attack == other.attack and self.defense == other.defense
        return False
class Player:
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        opponent_deck_cards = opponent.deck.copy().cards
        for item in opponent_deck_cards:
