...
marie = TutorCard('Marie, Arbiter of Justice and Herald of Seraphs, True Heir to the Last Monarch of Ra’toth', 1150,
                  2200)
...
standard_cards = [denero, sean, jade, richard_r, griffin, albert, shayna, addison, cesar, catherine, amrita, laryn,
                  parth, todd, crystal, ben, cyrus, roy, animesh, megan, yersultan, connie, jenny, jeffrey, marie, linh,
                  benny, tim, emma, richard_z, brandon, daphne, jamie]
